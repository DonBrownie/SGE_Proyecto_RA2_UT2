...
Primero accederemos a la web oficial de Odoo y tendremos dos versiones la *Community* y la *Enterprise*, para la community necesitaremos rellenar un formulario y nos instalaremos el instalador (.exe) en cambio para la enterprise será necesario poner el número de la licencia
