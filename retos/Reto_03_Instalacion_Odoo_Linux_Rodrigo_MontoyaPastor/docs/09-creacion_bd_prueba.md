...
2. Crea una **base de datos nueva** con email/contraseña admin.
   ...
   ![Crear BD](../assets/img/09-creacion_bd_prueba/creacion-BD.png "Crear base de datos")
3. Selecciona módulos iniciales si procede.
   ...
   ![Crear BD](../assets/img/09-creacion_bd_prueba/creacion-Acceso.png "Crear base de datos")
